...
class Myspider(scrapy.Spider):
    ...
    start_urls = ['http://www.gaokaopai.com/daxue-0-0-0-0-0-0-0--p-%s.html' %p for p in range(1,100)]  #(1,3055)
    ...
    def parse2(self, response):
        ...
        for item in score[1:]:
            if len(item)>3:
                code = str(uuid.uuid3(uuid.NAMESPACE_DNS,str(item)))
                ...
                # 批次，0：本科一批，1：本科二批，2：本科三批，3：本科提前批，4：专科，5：高职高专，6：本科二三批
